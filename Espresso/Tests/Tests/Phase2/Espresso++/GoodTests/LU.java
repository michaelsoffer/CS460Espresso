...
public class LU {
   ...
   * 
   * @return the pivot vector used in obtaining the LU factorzation. Subsequent solutions must permute the right-hand side by this vector.
   * 
   */
  public int[] getPivot() {
  ...
  public static void main(String args[]) {
    double[][] d = new double[][] { { 1.0, 2.0, 3.0, 4.0 },
        { 4.0, 3.0, 2.0, 1.0 }, { 3.0, 4.0, 1.0, 2.0 },
        { 2.0, 3.0, 4.0, 1.0 } };
